...
{
    public partial class MeasureNomalFirst : UserControl, IPageChangeNotifier
    {
        ...
        public MeasureNomalFirst()
        {
            ...
            webView.Source = new Uri("http://192.168.0.103:8554");
            ...
            //초기화 및 웹 페이지 URL 설정
            //webView.Source = new Uri("http://192.168.0.28:8554");
            //webView.Source = new Uri("http://192.168.0.26:8554");
            //webBrowser.Navigate = new Uri("http://192.168.0.103:8554");
        }
        ...
        private void btnReStart_Click(object sender, EventArgs e)
        {
            ...
            //this.Invoke(new Action(() => MovePage(new MeasureForm())));
            loadpop.Close();
        }
        ...
        private void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            this.Invoke(new Action(() => MovePage(typeof(MeasureReadyForm))));
            //this.Invoke(new Action(() => MovePage(new MeasureReadyForm())));
            loadpop.Close();
        }
